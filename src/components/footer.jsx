        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8">
          ...
          <div className="flex flex-col  items-center gap-3 mb-4 relative ">
            <div className="flex gap-3">
              <div className="h-10 w-10 md:h-12 md:w-12 rounded-full overflow-hidden bg-white flex items-center justify-center flex-shrink-0 p-1">
                <img
                  src="/assets/s-f-logo.png"
                  alt="Logo"
          ...
          <div>
            ...
            <div className="flex gap-3 md:gap-4 mb-4 md:mb-6">
              <a
                href="#"
                className="w-10 h-10 md:w-12 md:h-12 bg-slate-700 hover:bg-slate-600 rounded flex items-center justify-center transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
