...
const projects = [
  ...
  },
  {
    ...
    description: "Establishing marine protected areas to preserve biodiversity and restore coral reefs along Africa's coastline.",
  ...
  },
  {
    ...
    image: "/assets/Regreening-Africa.jpg",
  },
  {
    id: 5,
    category: "wetlands",
  ...
  },
  {
    ...
    description: "Teaching young Africans to build green businesses in renewable energy, waste management, and sustainable agriculture.",
    location: "Kenya",
    duration: "2024 - 2027",
  ...
  },
  {
    ...
    description: "Funding field research and academic partnerships to develop evidence-based conservation solutions for African ecosystems.",
      ...
      <div className="relative h-[320px] sm:h-[400px] md:h-[500px] w-full">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white px-4">
          ...
          <p className="text-sm sm:text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
            Join us in transforming Africa's future through reforestation, water
